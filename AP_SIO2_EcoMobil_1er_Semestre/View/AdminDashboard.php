    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: "Segoe UI", sans-serif; }
        ...
        .agency-status {
            ...
            padding: 5px 15px; font-size: 0.8rem; font-weight: bold;
            border-bottom-left-radius: 15px; color: white; background-color: var(--accent-green);
        }
        .agency-icon {
            width: 50px; height: 50px; border-radius: 50%;
            background: #e0e5ec; box-shadow: var(--neu-flat);
...
<div class="main-content">
        ...
        <div class="dashboard-grid">
            <div class="neu-card">
                ...
                <table class="data-table">
                    ...
                    <?php endforeach; else: ?>
                        <tr><td colspan="3" style="text-align:center; padding:20px;">Aucune donnée.</td></tr>
                    <?php endif; ?>
    ...
    <section id="section-agences" class="content-section">
        ...
        <div class="agencies-grid">
            <?php foreach($agences as $agence):
                // FILTRE VISUEL : Exclure Meylan, Lyon, Bron
            ...
            <table class="data-table">
                ...
                <?php if(!empty($reservations)): ?>
                    <?php foreach($reservations as $res):
                        ...
                        if(strtolower($res['statut_reservation']) == 'terminée') $badgeClass = 'badge-blue';
                        ?>
                        <tr>
                    ...
                    <?php endforeach; ?>
                <?php else: ?>
                    <tr><td colspan="6" style="text-align:center; padding:15px;">Aucune réservation récente.</td></tr>
                <?php endif; ?>
                </tbody>
            </table>
        </div>
    ...
    <section id="section-users" class="content-section">
        ...
        <div class="neu-card">
            <table class="data-table">
                <thead><tr><th style="padding-left: 10px">Réf. Res.</th><th>Participant</th><th>Véhicule Attribué</th><th>Statut</th></tr></thead>
                <tbody>
                <?php if(!empty($participants)): ?>
                    ...
                    <?php endforeach; ?>
                <?php else: ?>
                    <tr><td colspan="4" style="text-align:center; padding:15px;">Aucun participant trouvé.</td></tr>
                <?php endif; ?>
                </tbody>
            </table>
        </div>
    ...
    <section id="section-parc" class="content-section">
        ...
        <div class="parc-grid">
            <?php foreach($parc as $p):
                ...
                $color = ($percent < 20) ? 'var(--accent-red)' : 'var(--accent-green)';
                ?>
                <div class="neu-card parc-card">
                    ...
                    <div class="parc-info">
                        ...
                        <div class="parc-stats">
                            ...
                            <span style="color: <?php echo $color; ?>"><?php echo $p['dispo']; ?> Dispo</span>
                        </div>
                        <div class="progress-bg">
                            <div class="progress-fill" style="width: <?php echo $percent; ?>%; background-color: <?php echo $color; ?>"></div>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
